        ...
        <table class="table table-borderless">
            ...
            <tbody>
                ...
                <?php foreach ($result as $row): ?>
                    <tr>
                        <td><a href="view_painting.php?id=<?= $row['paintingId'] ?>"><img class="icon"
                                    src="Icons/view.png"></a></td>
                        <td><a href="edit_painting.php?id=<?= $row['paintingId'] ?>"><img class="icon-small"
                                    src="Icons/edit.png"></a></td>
                        <td><a href="delete_painting.php?id=<?= $row['paintingId'] ?>"><img class="icon-small"
                                    src="Icons/delete.png"></a></td>
                        <td><img src="data:image/png;base64, <?= base64_encode($row['paintingThumbnail']) ?>"
                                style="width:100" /></td>
                        <td>
                            <?= $row['paintingTitle'] ?>
                        </td>
